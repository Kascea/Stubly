          ...
          {orders.length > 0 ? (
            <div className="space-y-6">
              {orders.map((order) => (
                <Card
                  key={order.order_id}
                  className="group hover:shadow-xl transition-all duration-300 border-0 shadow-md bg-white/80 backdrop-blur-sm hover:bg-white/90"
                >
                  <CardContent className="p-6">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 lg:gap-6">
                        {/* Tickets Preview */}
                        <div className="flex items-center gap-3 px-4 py-2 bg-sky-50/50 rounded-lg border border-sky-100/50">
                        ...
                        {/* Total Amount */}
                        <div className="flex items-center gap-3 px-4 py-2 bg-gray-50/50 rounded-lg border border-gray-100/50">
                          <div className="text-sm">
                        ...
                        <Link href={route("orders.show", order.order_id)}>
                          <Button
                            variant="outline"
                            className="relative border-sky-200 text-sky-800 hover:bg-sky-50
                              transition-all duration-300 hover:scale-105 hover:shadow-md
                              flex items-center gap-2 overflow-hidden group/btn
                              bg-white/50 backdrop-blur-sm"
                          >
                            <span>View Details</span>
                            <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover/btn:translate-x-1" />
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-sky-100/30 to-transparent -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700 ease-out" />
                          </Button>
                        </Link>
                      </div>
                    </div>
