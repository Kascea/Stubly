...
const BroadwayCreativeTemplate = forwardRef(({ ticketInfo }, ref) => {
...
BroadwayCreativeTemplate.displayName = "BroadwayCreativeTemplate";

export default BroadwayCreativeTemplate;
