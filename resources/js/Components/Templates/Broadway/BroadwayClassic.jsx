...
const BroadwayClassicTemplate = forwardRef(({ ticketInfo }, ref) => {
  return (
...
BroadwayClassicTemplate.displayName = "BroadwayClassicTemplate";

export default BroadwayClassicTemplate;
